...
FCF_PARALLEL_UNIT(
  ...
  void FCF_PARALLEL_MAIN(
    ...
    fcf_float32 a_sourceValue,
    FCF_PARALLEL_GLOBAL const fcf_float32* a_sourceArr,
    FCF_PARALLEL_GLOBAL fcf_float32* a_destArr1,
    FCF_PARALLEL_GLOBAL fcf_float32* a_destArr2
    ){
...
void floatTypesTest(){
  std::cout << "Start floatTypesTest..." << std::endl;
  {
